...
from utils.html import allure_html_img_base64_string, allure_html_list, allure_html_table, allure_html_img_full_page


@allure.epic('Пагинация')
class TestPagination:
    ...
    def test_open_page(self, wd, url):
        wd.get(url)
        count = 0
        while count < 5:
            count += 1
    ...
    def test_pagination_element(self, wd, schema):
    ...
    def test_links_validate(self, wd):
    ...
    def test_links_diff_one_part(self, wd, schema):
    ...
    def test_link_diff_query_param(self, wd):
    ...
    def test_query_params_one_key(self, wd):
    ...
    def test_query_params_text(self, wd, schema):
